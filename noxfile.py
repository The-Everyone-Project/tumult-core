...
transformations and measurements, plus the self-tests of the parity harness
they are written against. It will grow as more of the pandas backend lands;
everything under it that still needs Spark is marked and deselected rather than
excluded by path."""
